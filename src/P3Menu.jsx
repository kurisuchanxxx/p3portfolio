...
const ITEMS = [
  { id: "about",   label: "CHI SONO",      page: "about",   fontSize: 80, offsetX: 0,  offsetY: 0,  skew: -6,  skewY: 10  },
  { id: "resume",  label: "CURRICULUM",    page: "resume",  fontSize: 66, offsetX: 20, offsetY: 8,  skew: -11, skewY: -10 },
  { id: "github",  label: "LINK GITHUB",   page: "github",  fontSize: 68, offsetX: 8, offsetY: 6,  skew: 0, skewY: -4  },
  { id: "socials", label: "SOCIAL",        page: "socials", fontSize: 74, offsetX: 16, offsetY: 8,  skew: -3,  skewY: 5   },
  { id: "sideproj",label: "PROGETTI",      page: "sideproj",fontSize: 56, offsetX: 10, offsetY: 6,  skew: -4,  skewY: 7   },
];
...
export default function P3Menu({ onNavigate }) {
  ...
  useEffect(() => {
    const onKey = (e) => {
      ...
      if (e.key === "Enter") {
        if (ITEMS[active].page === "github") {
          window.open("https://github.com/kurisuchanxxx", "_blank");
        } else {
  ...
  return (
    <>
      <style>{`
        ...
        .p3-stripe  { display: none; }
        .p3-stripe2 { display: none; }
      ...
      <div className="p3-overlay">
        ...
        <div className={`p3-hint ${mounted ? "mounted" : ""}`}>
          <div className="p3-hint-row"><span className="p3-hint-key">↑↓</span><span>NAVIGA</span></div>
          <div className="p3-hint-row"><span className="p3-hint-key">↵</span><span>CONFERMA</span></div>
        </div>
      </div>
    </>
  );
