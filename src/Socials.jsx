...
const ITEMS = [
  {
    id: "discord", label: "DISCORD", handle: "kurisuchanx", href: "https://discord.com/users/kurisuchanx", icon: "💬", barIcon: icon1, bars: 1, newBars: [0], counts: ["89"],
    links: ["discord.com/users/kurisuchanx"],
    stats: [
      { tag: "FRN", value: "324", color: "#5865F2" },
      { tag: "SVR", value: "12",  color: "#99aab5" },
    ],
  },
  {
    id: "instagram", label: "INSTAGRAM", handle: "@christianlantieri", href: "https://www.instagram.com/christianlantieri/", icon: "📷", barIcon: icon2, bars: 5, newBars: [1, 2], counts: ["3.4M", "2.5M", "676K", "412K", "198K"],
    links: ["instagram.com/p/...", "instagram.com/p/...", "instagram.com/reel/...", "instagram.com/p/...", "instagram.com/reel/..."],
    stats: [
      { tag: "FOL", value: "1.2K", color: "#e1306c" },
      { tag: "PST", value: "84",  color: "#f77737" },
    ],
  },
  {
    id: "linkedin", label: "LINKEDIN", handle: "Christian Ray Lantieri", href: "https://www.linkedin.com/in/christianraylantieri/", icon: "💼", barIcon: icon3, bars: 7, newBars: [0, 3, 5, 6], counts: ["12K", "8K", "5K", "3K", "1.2K", "800", "300"],
    links: ["linkedin.com/in/christianraylantieri", "linkedin.com/in/christianraylantieri/recent-activity/all/", "linkedin.com/in/christianraylantieri/details/experience/", "linkedin.com/in/christianraylantieri/details/education/", "linkedin.com/in/christianraylantieri/details/skills/", "linkedin.com/in/christianraylantieri/details/recommendations/", "linkedin.com/in/christianraylantieri/details/projects/"],
    stats: [
      { tag: "CON", value: "500+", color: "#0077b5" },
      { tag: "PST", value: "42",  color: "#00a0dc" },
    ],
  },
];
  ...
  return (
    <div id="menu-screen">
      ...
      <style>{`
        ...
        .sc-bar-outer.active .sc-open-btn {
          color: #000;
        ...
        .sc-main {
          ...
          justify-content: center;
          gap: 3px;
          padding-left: clamp(52px, 6vw, 92px);
        }
        .sc-main-top {
          display: flex;
          align-items: center;
      ...
      {mounted && Array.from({ length: ITEMS[active].bars }).map((_, i) => (
        ...
        >
          ...
          <div className="sc-info-bar">
            ...
            <span className="sc-info-bar-box">VISUALIZZAZIONI</span>
      ...
      <div className={`sc-footer${mounted ? " mounted" : ""}`}>
        <div className="sc-footer-row"><span className="sc-footer-key">↑↓</span><span>SELEZIONA</span></div>
        <div className="sc-footer-row"><span className="sc-footer-key">↵</span><span>VISITA</span></div>
        <div className="sc-footer-row"><span className="sc-footer-key">ESC</span><span>INDIETRO</span></div>
      </div>
      <div
