...
const REVEAL_CONTENT = [
  {
    upper: [
      "Christian Ray, 25 anni",
      "Sviluppatore web · imprenditore",
      "Mente ibrida tra strategia, design",
  ...
  {
    upper: [
      "Ho un percorso piuttosto misto:",
      "informatica → economia → management e innovazione.",
      "Nel tempo libero sono un avido videogiocatore, surfer, skateboarder,",
      "tatuatore e dungeon master.",
    ],
    lower: "curiosità",
  },
  {
    upper: [
      "Fuori dal lavoro: videogiochi, surf, skate,",
      "tatuaggi e Dungeons & Dragons.",
      "Mi affascinano stile, ritmo e personalità,",
      "con un mix tra strategia e istinto."
    ],
    lower: "cose strane su di me",
  },
];
...
const ITEMS = [
  {
    id: "twitch", label: "CHI SONO", handle: "@yourname", icon: "🎮", barIcon: icon1, bars: 1, newBars: [0], counts: ["56"],
  ...
  {
    id: "instagram", label: "CURIOSITÀ", handle: "@yourhandle", icon: "📷", barIcon: icon2, bars: 5, newBars: [1, 2], counts: ["3.4M", "2.5M", "676K", "412K", "198K"],
  ...
  {
    id: "tiktok", label: "COSE STRANE SU DI ME", handle: "@yourhandle", icon: "🎵", barIcon: icon3, bars: 7, newBars: [0, 3, 5, 6], counts: ["5.1M", "3.7M", "2.2M", "1.4M", "831K", "490K", "217K"],
  ...
  return (
    <div id="menu-screen">
      ...
      <style>{`
        ...
        .sc-bar-outer.active .sc-open-indicator {
          ...
          >
            ...
            <div className="sc-bar">
              ...
              <div className="sc-bar-content">
                ...
                <div className="sc-open-indicator">▸</div>
              </div>
            </div>
          </div>
        ))}
      ...
      <div className={`sc-footer${mounted ? ' mounted' : ''}`}>
        ...
        <div className="sc-footer-row"><span className="sc-footer-key">↵</span><span>RIVELA</span></div>
